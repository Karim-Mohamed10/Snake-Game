...
LCD_WRITE FUNCTION
	...
	;TODO: SET PA0-7 WITH THE LOWER 8-bits of R2
...
LCD_INIT FUNCTION
	...
	;TODO: SET RESET PIN TO HIGH (THIS CORRESPONDS TO SETTING B7 TO HIGH)
	LDR R1, =GPIOB_ODR_OFFSET
	LDR R0, [R1]
	MOV R3, #1
	ORR R0, R0, R3, LSL #15
	...
	;TODO: RESET RESET PIN TO LOW (SET B15 TO 0)
	LDR R1, =GPIOB_ODR_OFFSET
	LDR R0, [R1]
	MOV R3, #1
	LSL R3, #15
	...
	;TODO: SET CS PIN HIGH (SET B6 TO HIGH)
	LDR R1, =GPIOB_ODR_OFFSET
	LDR R0, [R1]
	MOV R3, #1
	ORR R0, R0, R3, LSL #6
